...
import { FOOD_CATALOG, FOOD_CATEGORY_LABEL, type FoodCategory } from "@/lib/mock-food";
import { useBooking } from "@/lib/booking-context";

const CATEGORIES: FoodCategory[] = ["POPCORN", "DRINKS", "SNACKS", "COMBOS", "HOT_FOOD"];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        <div className="space-y-8">
          {CATEGORIES.map((cat) => {
            const items = FOOD_CATALOG.filter((f) => f.category === cat);
